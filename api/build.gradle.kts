...
tasks {
    javadoc {
        title = "LanguageLib API " + project.version
        options {
            (this as StandardJavadocDocletOptions).apply {
                charSet = "UTF-8"
                encoding = "UTF-8"
                docEncoding = "UTF-8"
                bottom = "Copyright © 2025 Lucaaa. All rights reserved. Licensed under GPL 3.0. View the source code <a href=\"https://github.com/Luncaaa/LanguageLib\">here</a>"
